...
res_3T <- readRDS("data/elasticnet_res2_glmnet_3T.RDS")
res_7T <- readRDS("data/elasticnet_res2_glmnet_7T.RDS")
...
save(stat_res, file = "data/predict2_glmnet_output.RData")
...
# x11()
png("output/glmnet_scatterplot2_3T.png")
par(mfrow = c(2,3))
...
# x11()
png("output/glmnet_scatterplot2_7T.png")
par(mfrow = c(2,3))
...
pdf("output/glmnet_scatterplot2_3T_7T.pdf")
par(mfrow = c(2,3))
